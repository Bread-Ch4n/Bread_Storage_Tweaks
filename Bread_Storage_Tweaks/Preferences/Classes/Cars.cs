...
public static class Cars
{
    ...
    private static MelonPreferences_Entry<int>? _hotBoxSlotAmount;
    ...
    private static MelonPreferences_Entry<int>? _hotBoxRowAmount;
    ...
    public static void Init()
    {
        ...
        _hotBoxSlotAmount = _carSlotAmountCategory.CreateEntry("Hotbox Slot Amount", 5);
        ...
        _hotBoxRowAmount = _carRowAmountCategory.CreateEntry("Hotbox Row Amount", 1);
    ...
    public static int GetSA(StorageEntity storageEntity) =>
        storageEntity.name switch
        {
            ...
            _ when storageEntity.name.Contains("BoxSUV") => _hotBoxSlotAmount!.Value,
    ...
    public static int GetRA(StorageEntity storageEntity) =>
        storageEntity.name switch
        {
            ...
            _ when storageEntity.name.Contains("BoxSUV") => _hotBoxRowAmount!.Value,
